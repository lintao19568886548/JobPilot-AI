...
$database="jobpilot_phase10_migration_check_$PID"
$port=18090
...
try{
  ...
  $stdout=Join-Path $runtime 'phase10-migration-check.out.log';$stderr=Join-Path $runtime 'phase10-migration-check.err.log'
  ...
  $parts=$result-split',';if($parts.Count-ne3-or$parts[0]-ne'10'-or$parts[1]-ne'10'-or$parts[2]-ne'80'){throw "Unexpected migration result: $result"}
